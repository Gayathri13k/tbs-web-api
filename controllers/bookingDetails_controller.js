...
const putPrice = async (req, res) => {
    ...
    try {
        ...
        const boardingTimeOnly = formatTo12Hour(extractTime(boardingTime));
        const droppingTimeOnly = formatTo12Hour(extractTime(droppingTime));
        ...
        const formattedTravelDate = `${formatDate(travelDate)} ${formatTo12Hour(travelDate)}`;
