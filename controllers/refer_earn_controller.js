...
const postReferEarnContent = async (req, res) => {
    ...
    try {
        ...
        const result = await tbsWebPool.query(query, [procedure, referral_amount]);
...
const postReferEarn = async (req, res) => {
    ...
    try {
        ...
        const { rows: passengerRows } = await tbsWebPool.query(
        ...
        const insertReferEarnQuery = `
            ...
            VALUES ($1, $2, $3, $4, $5)
        `;
        await tbsWebPool.query(insertReferEarnQuery, [referral_code, mobile_number, user_name, referralListJson, earned_amount]);
