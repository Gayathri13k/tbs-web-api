...
const Filtersin = async (req, res) => {
    ...
    try {
        ...
        if (departure_time_range) {
            const currentDate = departure_date
            switch (departure_time_range) {
                case '6am-11am':
                    jsonFilters += ` AND (departure_date_time BETWEEN $${queryParams.length + 1} AND $${queryParams.length + 2})`;
                    queryParams.push(`${currentDate} 06:00:00`, `${currentDate} 11:00:00`);
                    break;
                case '11am-6pm':
                    jsonFilters += ` AND (departure_date_time BETWEEN $${queryParams.length + 1} AND $${queryParams.length + 2})`;
                    queryParams.push(`${currentDate} 11:00:00`, `${currentDate} 18:00:00`);
                    break;
                case '6pm-11pm':
                    jsonFilters += ` AND (departure_date_time BETWEEN $${queryParams.length + 1} AND $${queryParams.length + 2})`;
                    queryParams.push(`${currentDate} 18:00:00`, `${currentDate} 22:59:59`);
                    break;
                case '11pm-6am':
                    jsonFilters += ` AND (departure_date_time >= $${queryParams.length + 1} OR departure_date_time < $${queryParams.length + 2})`;
                    queryParams.push(`${currentDate} 23:00:00`, `${currentDate} 06:00:00`);
                    break;
                default:
                    break;
            }
        ...
        if (arrival_time_range) {
            const currentDate = departure_date
            switch (arrival_time_range) {
                case '6am-11am':
                    jsonFilters += ` AND (arrival_date_time BETWEEN $${queryParams.length + 1} AND $${queryParams.length + 2})`;
                    queryParams.push(`${currentDate} 06:00:00`, `${currentDate} 11:00:00`);
                    break;
                case '11am-6pm':
                    jsonFilters += ` AND (arrival_date_time BETWEEN $${queryParams.length + 1} AND $${queryParams.length + 2})`;
                ...
                case '6pm-11pm':
                    jsonFilters += ` AND (arrival_date_time BETWEEN $${queryParams.length + 1} AND $${queryParams.length + 2})`;
                    queryParams.push(`${currentDate} 18:00:00`, `${currentDate} 23:00:00`);
                    break;
                case '11pm-6am':
                    jsonFilters += ` AND (arrival_date_time >= $${queryParams.length + 1} OR arrival_date_time < $${queryParams.length + 2})`;
                    queryParams.push(`${currentDate} 23:00:00`, `${currentDate} 06:00:00`);
                    break;
                default:
                    break;
